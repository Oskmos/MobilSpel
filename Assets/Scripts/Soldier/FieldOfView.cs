...
public class FieldOfView : MonoBehaviour
{
   ...
   private void RotateSoldier()
   {
      ...
      if (visibleTargets.Count > 0)
      {
         ...
         soldier.transform.rotation = Quaternion.RotateTowards(soldier.transform.rotation,rotation, 0.3f);;
      ...
      {
         soldier.transform.rotation = Quaternion.RotateTowards(soldier.transform.rotation,defaultRotation, 0.1f);
